...
var instantify = function () {
  ...
  return function instantify(_x2) {
...
var Tner = function () {
  function Tner(el) {
    ...
    this._handleTransitionend = function () {
      _Object$assign(_this2.el.style, {
  ...
  _createClass(Tner, [{
    ...
    key: '_willChangeProps',
    get: function get() {
      return _Object$keys(this._from);
    }
  }, {
    key: 'reverse',
    get: function get() {
  ...
  _createClass(ApocModal, [{
    ...
    get: function get() {
      var siblings = Array.prototype.slice.call(this.opts.container.children).filter(function (el) {
        return el.getAttribute('data-apoc-modal-sibling') !== null;
      });
