 ...
 * https://github.com/nju33/apoc-modal
 */
var ApocModal = (function () {
'use strict';
...
var _iterDefine = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      if (!_library && !_has$2(IteratorPrototype, ITERATOR)) _hide$2(IteratorPrototype, ITERATOR, returnThis);
    }
  }
...
var runtime$2 = createCommonjsModule$1$1(function (module) {
/**
 * Copyright (c) 2014-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
var _global$2$1 = createCommonjsModule$1$1(function (module) {
// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
var global = module.exports = typeof window != 'undefined' && window.Math == Math
  ? window : typeof self != 'undefined' && self.Math == Math ? self
  // eslint-disable-next-line no-new-func
...
var _core$2$1 = createCommonjsModule$1$1(function (module) {
var core = module.exports = { version: '2.5.1' };
if (typeof __e == 'number') __e = core; // eslint-disable-line no-undef
});

var _core_1$1$1 = _core$2$1.version;

var _aFunction$2$1 = function (it) {
  if (typeof it != 'function') throw TypeError(it + ' is not a function!');
  return it;
};
...
var _ctx$2$1 = function (fn, that, length) {
  _aFunction$2$1(fn);
  if (that === undefined) return fn;
  switch (length) {
    case 1: return function (a) {
...
var _isObject$2$1 = function (it) {
  return typeof it === 'object' ? it !== null : typeof it === 'function';
};

var _anObject$2$1 = function (it) {
  if (!_isObject$2$1(it)) throw TypeError(it + ' is not an object!');
  return it;
};

var _fails$2$1 = function (exec) {
  try {
    return !!exec();
  } catch (e) {
    return true;
...
// Thank's IE8 for his funny defineProperty
var _descriptors$2$1 = !_fails$2$1(function () {
  return Object.defineProperty({}, 'a', { get: function () { return 7; } }).a != 7;
});

var document$1$1$1 = _global$2$1.document;
// typeof document.createElement is 'object' in old IE
var is$1$1 = _isObject$2$1(document$1$1$1) && _isObject$2$1(document$1$1$1.createElement);
var _domCreate$2$1 = function (it) {
  return is$1$1 ? document$1$1$1.createElement(it) : {};
};

var _ie8DomDefine$2$1 = !_descriptors$2$1 && !_fails$2$1(function () {
  return Object.defineProperty(_domCreate$2$1('div'), 'a', { get: function () { return 7; } }).a != 7;
});
...
// instead of the ES6 spec version, we didn't implement @@toPrimitive case
// and the second argument - flag - preferred type is a string
var _toPrimitive$2$1 = function (it, S) {
  if (!_isObject$2$1(it)) return it;
  var fn, val;
  if (S && typeof (fn = it.toString) == 'function' && !_isObject$2$1(val = fn.call(it))) return val;
  if (typeof (fn = it.valueOf) == 'function' && !_isObject$2$1(val = fn.call(it))) return val;
  if (!S && typeof (fn = it.toString) == 'function' && !_isObject$2$1(val = fn.call(it))) return val;
  throw TypeError("Can't convert object to primitive value");
};
...
var f$4 = _descriptors$2$1 ? Object.defineProperty : function defineProperty(O, P, Attributes) {
  _anObject$2$1(O);
  P = _toPrimitive$2$1(P, true);
  _anObject$2$1(Attributes);
  if (_ie8DomDefine$2$1) try {
...
var _propertyDesc$2$1 = function (bitmap, value) {
  return {
    enumerable: !(bitmap & 1),
    configurable: !(bitmap & 2),
    writable: !(bitmap & 4),
...
var _hide$2$1 = _descriptors$2$1 ? function (object, key, value) {
  return _objectDp$2$1.f(object, key, _propertyDesc$2$1(1, value));
} : function (object, key, value) {
  object[key] = value;
  return object;
};
...
var $export$2$1 = function (type, name, source) {
  var IS_FORCED = type & $export$2$1.F;
  var IS_GLOBAL = type & $export$2$1.G;
  var IS_STATIC = type & $export$2$1.S;
  var IS_PROTO = type & $export$2$1.P;
  var IS_BIND = type & $export$2$1.B;
  var IS_WRAP = type & $export$2$1.W;
  var exports = IS_GLOBAL ? _core$2$1 : _core$2$1[name] || (_core$2$1[name] = {});
  var expProto = exports[PROTOTYPE$2];
  var target = IS_GLOBAL ? _global$2$1 : IS_STATIC ? _global$2$1[name] : (_global$2$1[name] || {})[PROTOTYPE$2];
  var key, own, out;
  if (IS_GLOBAL) source = name;
  for (key in source) {
    // contains in native
    ...
    exports[key] = IS_GLOBAL && typeof target[key] != 'function' ? source[key]
    // bind timers to global for call from export context
    : IS_BIND && own ? _ctx$2$1(out, _global$2$1)
    // wrap global constructors for prevent change them in library
    : IS_WRAP && target[key] == out ? (function (C) {
      var F = function (a, b, c) {
        if (this instanceof C) {
      ...
      return F;
    // make static versions for prototype methods
    })(out) : IS_PROTO && typeof out == 'function' ? _ctx$2$1(Function.call, out) : out;
    // export proto methods to core.%CONSTRUCTOR%.methods.%NAME%
    if (IS_PROTO) {
      (exports.virtual || (exports.virtual = {}))[key] = out;
      // export proto methods to core.%CONSTRUCTOR%.prototype.%NAME%
      if (type & $export$2$1.R && expProto && !expProto[key]) _hide$2$1(expProto, key, out);
    }
  }
};
// type bitmap
$export$2$1.F = 1;   // forced
$export$2$1.G = 2;   // global
$export$2$1.S = 4;   // static
$export$2$1.P = 8;   // proto
$export$2$1.B = 16;  // bind
$export$2$1.W = 32;  // wrap
$export$2$1.U = 64;  // safe
$export$2$1.R = 128; // real proto method for `library`
var _export$2$1 = $export$2$1;
...
// eslint-disable-next-line no-prototype-builtins
var _iobject$2$1 = Object('z').propertyIsEnumerable(0) ? Object : function (it) {
  return _cof$2$1(it) == 'String' ? it.split('') : Object(it);
};

// 7.2.1 RequireObjectCoercible(argument)
var _defined$2$1 = function (it) {
  if (it == undefined) throw TypeError("Can't call method on  " + it);
  return it;
};
...
var _toIobject$2$1 = function (it) {
  return _iobject$2$1(_defined$2$1(it));
};

// 7.1.4 ToInteger
var ceil$1$1 = Math.ceil;
var floor$1$1 = Math.floor;
var _toInteger$2$1 = function (it) {
  return isNaN(it = +it) ? 0 : (it > 0 ? floor$1$1 : ceil$1$1)(it);
};

// 7.1.15 ToLength

var min$2$1 = Math.min;
var _toLength$2$1 = function (it) {
  return it > 0 ? min$2$1(_toInteger$2$1(it), 0x1fffffffffffff) : 0; // pow(2, 53) - 1 == 9007199254740991
};

var max$1$1 = Math.max;
var min$1$1$1 = Math.min;
var _toAbsoluteIndex$2$1 = function (index, length) {
  index = _toInteger$2$1(index);
  return index < 0 ? max$1$1(index + length, 0) : min$1$1$1(index, length);
};
...
var _arrayIncludes$2$1 = function (IS_INCLUDES) {
  return function ($this, el, fromIndex) {
    var O = _toIobject$2$1($this);
    var length = _toLength$2$1(O.length);
    var index = _toAbsoluteIndex$2$1(fromIndex, length);
    var value;
    // Array#includes uses SameValueZero equality algorithm
    // eslint-disable-next-line no-self-compare
    if (IS_INCLUDES && el != el) while (length > index) {
...
var store$1$1 = _global$2$1[SHARED$1$1] || (_global$2$1[SHARED$1$1] = {});
var _shared$2$1 = function (key) {
  return store$1$1[key] || (store$1$1[key] = {});
};

var id$1$1 = 0;
var px$1$1 = Math.random();
var _uid$2$1 = function (key) {
  return 'Symbol('.concat(key === undefined ? '' : key, ')_', (++id$1$1 + px$1$1).toString(36));
};

var shared$1$1 = _shared$2$1('keys');

var _sharedKey$2$1 = function (key) {
  return shared$1$1[key] || (shared$1$1[key] = _uid$2$1(key));
};

var arrayIndexOf$1$1 = _arrayIncludes$2$1(false);
var IE_PROTO$3 = _sharedKey$2$1('IE_PROTO');

var _objectKeysInternal$2$1 = function (object, names) {
  var O = _toIobject$2$1(object);
  var i = 0;
  var result = [];
  var key;
  for (key in O) if (key != IE_PROTO$3) _has$2$1(O, key) && result.push(key);
  // Don't enum bug & hidden keys
  while (names.length > i) if (_has$2$1(O, key = names[i++])) {
    ~arrayIndexOf$1$1(result, key) || result.push(key);
  }
  return result;
};

// IE 8- don't enum bug keys
var _enumBugKeys$2$1 = (
  'constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString,toString,valueOf'
).split(',');
...
var _objectKeys$2$1 = Object.keys || function keys(O) {
  return _objectKeysInternal$2$1(O, _enumBugKeys$2$1);
};

var f$1$1$1 = Object.getOwnPropertySymbols;

var _objectGops$2$1 = {
	f: f$1$1$1
};

var f$2$1$1 = {}.propertyIsEnumerable;
...
var _toObject$2$1 = function (it) {
  return Object(_defined$2$1(it));
};
...
var $assign$1$1 = Object.assign;

// should work with symbols and should have deterministic property order (V8 bug)
var _objectAssign$2$1 = !$assign$1$1 || _fails$2$1(function () {
  var A = {};
  var B = {};
  // eslint-disable-next-line no-undef
  var S = Symbol();
  ...
  A[S] = 7;
  K.split('').forEach(function (k) { B[k] = k; });
  return $assign$1$1({}, A)[S] != 7 || Object.keys($assign$1$1({}, B)).join('') != K;
}) ? function assign(target, source) { // eslint-disable-line no-unused-vars
  var T = _toObject$2$1(target);
  var aLen = arguments.length;
  var index = 1;
  var getSymbols = _objectGops$2$1.f;
  var isEnum = _objectPie$2$1.f;
  while (aLen > index) {
    var S = _iobject$2$1(arguments[index++]);
    var keys = getSymbols ? _objectKeys$2$1(S).concat(getSymbols(S)) : _objectKeys$2$1(S);
    var length = keys.length;
    var j = 0;
    var key;
    while (length > j) if (isEnum.call(S, key = keys[j++])) T[key] = S[key];
...
_export$2$1(_export$2$1.S + _export$2$1.F, 'Object', { assign: _objectAssign$2$1 });

var assign$1$1$1 = _core$2$1.Object.assign;

var assign$3$1 = createCommonjsModule$1$1(function (module) {
module.exports = { "default": assign$1$1$1, __esModule: true };
});

var _Object$assign$1$1 = unwrapExports$1$1(assign$3$1);

// true  -> String#at
// false -> String#codePointAt
var _stringAt$2 = function (TO_STRING) {
  return function (that, pos) {
    var s = String(_defined$2$1(that));
    var i = _toInteger$2$1(pos);
    var l = s.length;
    var a, b;
    if (i < 0 || i >= l) return TO_STRING ? '' : undefined;
    a = s.charCodeAt(i);
...
var _redefine$2 = _hide$2$1;

var _iterators$2 = {};

var _objectDps$2 = _descriptors$2$1 ? Object.defineProperties : function defineProperties(O, Properties) {
  _anObject$2$1(O);
  var keys = _objectKeys$2$1(Properties);
  var length = keys.length;
  var i = 0;
  var P;
  while (length > i) _objectDp$2$1.f(O, P = keys[i++], Properties[P]);
  return O;
};

var document$2$1 = _global$2$1.document;
...
var IE_PROTO$1$1$1 = _sharedKey$2$1('IE_PROTO');
...
var createDict$1 = function () {
  // Thrash, waste and sodomy: IE GC bug
  var iframe = _domCreate$2$1('iframe');
  var i = _enumBugKeys$2$1.length;
  var lt = '<';
  var gt = '>';
  var iframeDocument;
  iframe.style.display = 'none';
  ...
  while (i--) delete createDict$1[PROTOTYPE$1$1$1][_enumBugKeys$2$1[i]];
  return createDict$1();
};
...
var _objectCreate$2 = Object.create || function create(O, Properties) {
  var result;
  if (O !== null) {
    Empty$1[PROTOTYPE$1$1$1] = _anObject$2$1(O);
    result = new Empty$1();
    Empty$1[PROTOTYPE$1$1$1] = null;
    // add "__proto__" for Object.getPrototypeOf polyfill
    result[IE_PROTO$1$1$1] = O;
  } else result = createDict$1();
  return Properties === undefined ? result : _objectDps$2(result, Properties);
};

var _wks$2 = createCommonjsModule$1$1(function (module) {
var store = _shared$2$1('wks');

var Symbol = _global$2$1.Symbol;
var USE_SYMBOL = typeof Symbol == 'function';

var $exports = module.exports = function (name) {
  return store[name] || (store[name] =
    USE_SYMBOL && Symbol[name] || (USE_SYMBOL ? Symbol : _uid$2$1)('Symbol.' + name));
};

$exports.store = store;
});

var def$1 = _objectDp$2$1.f;

var TAG$2 = _wks$2('toStringTag');

var _setToStringTag$2 = function (it, tag, stat) {
  if (it && !_has$2$1(it = stat ? it : it.prototype, TAG$2)) def$1(it, TAG$2, { configurable: true, value: tag });
};

var IteratorPrototype$1 = {};

// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
_hide$2$1(IteratorPrototype$1, _wks$2('iterator'), function () { return this; });

var _iterCreate$2 = function (Constructor, NAME, next) {
  Constructor.prototype = _objectCreate$2(IteratorPrototype$1, { next: _propertyDesc$2$1(1, next) });
...
var IE_PROTO$2$1 = _sharedKey$2$1('IE_PROTO');
var ObjectProto$1 = Object.prototype;

var _objectGpo$2 = Object.getPrototypeOf || function (O) {
  O = _toObject$2$1(O);
  if (_has$2$1(O, IE_PROTO$2$1)) return O[IE_PROTO$2$1];
  if (typeof O.constructor == 'function' && O instanceof O.constructor) {
    return O.constructor.prototype;
...
var _iterDefine$2 = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      // fix for some old engines
      if (!_library$2 && !_has$2$1(IteratorPrototype, ITERATOR$4)) _hide$2$1(IteratorPrototype, ITERATOR$4, returnThis$1);
    }
  }
  // fix Array#{values, @@iterator}.name in V8 / FF
  ...
  if ((!_library$2 || FORCED) && (BUGGY$1 || VALUES_BUG || !proto[ITERATOR$4])) {
    _hide$2$1(proto, ITERATOR$4, $default);
  }
  // Plug for library
  ...
  if (DEFAULT) {
    ...
    } else _export$2$1(_export$2$1.P + _export$2$1.F * (BUGGY$1 || VALUES_BUG), NAME, methods);
  }
  return methods;
};
...
var es6_array_iterator$2 = _iterDefine$2(Array, 'Array', function (iterated, kind) {
  this._t = _toIobject$2$1(iterated); // target
  this._i = 0;                   // next index
  this._k = kind;                // kind
// 22.1.5.2.1 %ArrayIteratorPrototype%.next()
}, function () {
...
for (var i$1 = 0; i$1 < DOMIterables$1.length; i$1++) {
  ...
  var Collection$1 = _global$2$1[NAME$1];
  var proto$1 = Collection$1 && Collection$1.prototype;
  if (proto$1 && !proto$1[TO_STRING_TAG$1]) _hide$2$1(proto$1, TO_STRING_TAG$1, NAME$1);
...
// ES3 wrong here
var ARG$1 = _cof$2$1(function () { return arguments; }()) == 'Arguments';
...
var _classof$2 = function (it) {
  ...
  return it === undefined ? 'Undefined' : it === null ? 'Null'
    ...
    : ARG$1 ? _cof$2$1(O)
    // ES3 arguments fallback
    : (B = _cof$2$1(O)) == 'Object' && typeof O.callee == 'function' ? 'Arguments' : B;
};
...
var _iterCall$2 = function (iterator, fn, value, entries) {
  try {
    return entries ? fn(_anObject$2$1(value)[0], value[1]) : fn(value);
  // 7.4.6 IteratorClose(iterator, completion)
  } catch (e) {
    var ret = iterator['return'];
    if (ret !== undefined) _anObject$2$1(ret.call(iterator));
    throw e;
  }
};
...
var core_getIteratorMethod$2 = _core$2$1.getIteratorMethod = function (it) {
  if (it != undefined) return it[ITERATOR$2$1]
    || it['@@iterator']
    || _iterators$2[_classof$2(it)];
};

var _forOf$2 = createCommonjsModule$1$1(function (module) {
var BREAK = {};
var RETURN = {};
var exports = module.exports = function (iterable, entries, fn, that, ITERATOR) {
  var iterFn = ITERATOR ? function () { return iterable; } : core_getIteratorMethod$2(iterable);
  var f = _ctx$2$1(fn, that, entries ? 2 : 1);
  var index = 0;
  var length, step, iterator, result;
  if (typeof iterFn != 'function') throw TypeError(iterable + ' is not iterable!');
  // fast case for arrays with default iterator
  if (_isArrayIter$2(iterFn)) for (length = _toLength$2$1(iterable.length); length > index; index++) {
    result = entries ? f(_anObject$2$1(step = iterable[index])[0], step[1]) : f(iterable[index]);
    if (result === BREAK || result === RETURN) return result;
  } else for (iterator = iterFn.call(iterable); !(step = iterator.next()).done;) {
...
var _speciesConstructor$2 = function (O, D) {
  var C = _anObject$2$1(O).constructor;
  var S;
  return C === undefined || (S = _anObject$2$1(C)[SPECIES$2]) == undefined ? D : _aFunction$2$1(S);
};
...
var process$1$1 = _global$2$1.process;
var setTask$1 = _global$2$1.setImmediate;
var clearTask$1 = _global$2$1.clearImmediate;
var MessageChannel$1 = _global$2$1.MessageChannel;
var Dispatch$1 = _global$2$1.Dispatch;
var counter$1 = 0;
var queue$1 = {};
...
if (!setTask$1 || !clearTask$1) {
  ...
  // Node.js 0.8-
  if (_cof$2$1(process$1$1) == 'process') {
    defer$1 = function (id) {
      process$1$1.nextTick(_ctx$2$1(run$1, id, 1));
    };
  // Sphere (JS game engine) Dispatch API
  } else if (Dispatch$1 && Dispatch$1.now) {
    defer$1 = function (id) {
      Dispatch$1.now(_ctx$2$1(run$1, id, 1));
    };
  // Browsers with MessageChannel, includes WebWorkers
    ...
    defer$1 = _ctx$2$1(port$1.postMessage, port$1, 1);
  // Browsers with postMessage, skip WebWorkers
  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
  } else if (_global$2$1.addEventListener && typeof postMessage == 'function' && !_global$2$1.importScripts) {
    defer$1 = function (id) {
      _global$2$1.postMessage(id + '', '*');
    };
    _global$2$1.addEventListener('message', listener$1, false);
  // IE8-
  } else if (ONREADYSTATECHANGE$1 in _domCreate$2$1('script')) {
    defer$1 = function (id) {
      _html$2.appendChild(_domCreate$2$1('script'))[ONREADYSTATECHANGE$1] = function () {
  ...
  // Rest old browsers
    ...
    defer$1 = function (id) {
      setTimeout(_ctx$2$1(run$1, id, 1), 0);
    };
  }
}
var _task$2 = {
...
var Observer$1 = _global$2$1.MutationObserver || _global$2$1.WebKitMutationObserver;
var process$2$1 = _global$2$1.process;
var Promise$1$1 = _global$2$1.Promise;
var isNode$1$1 = _cof$2$1(process$2$1) == 'process';
...
var _microtask$2 = function () {
  ...
  // - setTimeout
    ...
    notify = function () {
      // strange IE + webpack dev server bug - use .call(global)
      macrotask$1.call(_global$2$1, flush);
    };
  }
...
function PromiseCapability$1(C) {
  ...
  this.resolve = _aFunction$2$1(resolve);
  this.reject = _aFunction$2$1(reject);
}

var f$3$1$1 = function (C) {
...
var _promiseResolve$2 = function (C, x) {
  _anObject$2$1(C);
  if (_isObject$2$1(x) && x.constructor === C) return x;
...
var _redefineAll$2 = function (target, src, safe) {
  for (var key in src) {
    if (safe && target[key]) target[key] = src[key];
    else _hide$2$1(target, key, src[key]);
  } return target;
};
...
var _setSpecies$2 = function (KEY) {
  var C = typeof _core$2$1[KEY] == 'function' ? _core$2$1[KEY] : _global$2$1[KEY];
  if (_descriptors$2$1 && C && !C[SPECIES$1$1]) _objectDp$2$1.f(C, SPECIES$1$1, {
    configurable: true,
    get: function () { return this; }
  });
};
...
var TypeError$1$1 = _global$2$1.TypeError;
var process$3 = _global$2$1.process;
var $Promise$1 = _global$2$1[PROMISE$1];
...
var isThenable$1 = function (it) {
  var then;
  return _isObject$2$1(it) && typeof (then = it.then) == 'function' ? then : false;
};
...
var onUnhandled$1 = function (promise) {
  task$1.call(_global$2$1, function () {
    var value = promise._v;
    ...
    if (unhandled) {
      result = _perform$2(function () {
        ...
        } else if (handler = _global$2$1.onunhandledrejection) {
          handler({ promise: promise, reason: value });
        } else if ((console = _global$2$1.console) && console.error) {
          console.error('Unhandled promise rejection', value);
        }
      });
      // Browsers should not trigger `rejectionHandled` event if it was handled here, NodeJS - should
...
var onHandleUnhandled$1 = function (promise) {
  task$1.call(_global$2$1, function () {
    ...
    } else if (handler = _global$2$1.onrejectionhandled) {
      handler({ promise: promise, reason: promise._v });
    }
  });
};
  ...
  try {
    ...
    if (then = isThenable$1(value)) {
      microtask$1(function () {
        var wrapper = { _w: promise, _d: false }; // wrap
        try {
          then.call(value, _ctx$2$1($resolve$1, wrapper, 1), _ctx$2$1($reject$1, wrapper, 1));
        } catch (e) {
...
if (!USE_NATIVE$1) {
  ...
  $Promise$1 = function Promise(executor) {
    ...
    _aFunction$2$1(executor);
    Internal$1.call(this);
    try {
      executor(_ctx$2$1($resolve$1, this, 1), _ctx$2$1($reject$1, this, 1));
    } catch (err) {
  ...
  OwnPromiseCapability$1 = function () {
    ...
    this.promise = promise;
    this.resolve = _ctx$2$1($resolve$1, promise, 1);
    this.reject = _ctx$2$1($reject$1, promise, 1);
  };
...
_export$2$1(_export$2$1.G + _export$2$1.W + _export$2$1.F * !USE_NATIVE$1, { Promise: $Promise$1 });
_setToStringTag$2($Promise$1, PROMISE$1);
_setSpecies$2(PROMISE$1);
Wrapper$1 = _core$2$1[PROMISE$1];

// statics
_export$2$1(_export$2$1.S + _export$2$1.F * !USE_NATIVE$1, PROMISE$1, {
  // 25.4.4.5 Promise.reject(r)
  reject: function reject(r) {
...
_export$2$1(_export$2$1.S + _export$2$1.F * (_library$2 || !USE_NATIVE$1), PROMISE$1, {
  // 25.4.4.6 Promise.resolve(x)
  resolve: function resolve(x) {
    return _promiseResolve$2(_library$2 && this === Wrapper$1 ? $Promise$1 : this, x);
  }
});
_export$2$1(_export$2$1.S + _export$2$1.F * !(USE_NATIVE$1 && _iterDetect$2(function (iter) {
...
_export$2$1(_export$2$1.P + _export$2$1.R, 'Promise', { 'finally': function (onFinally) {
  var C = _speciesConstructor$2(this, _core$2$1.Promise || _global$2$1.Promise);
  var isFunction = typeof onFinally == 'function';
  return this.then(
    isFunction ? function (x) {
...
_export$2$1(_export$2$1.S, 'Promise', { 'try': function (callbackfn) {
...
var promise$1$1 = _core$2$1.Promise;

var promise$3 = createCommonjsModule$1$1(function (module) {
module.exports = { "default": promise$1$1, __esModule: true };
});

var _Promise$1 = unwrapExports$1$1(promise$3);

var asyncToGenerator$1 = createCommonjsModule$1$1(function (module, exports) {
exports.__esModule = true;
...
var _asyncToGenerator$1 = unwrapExports$1$1(asyncToGenerator$1);
...
var Tner = function () {
  function Tner(el) {
    ...
    _classCallCheck$1(this, Tner);

    this._handleTransitionend = function () {
      _Object$assign$1(_this.el.style, {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                _Object$assign$1(this.el.style, this._optimisation, this._from);
                _context.next = 10;
                return pRestore();

              case 10:

                _Object$assign$1(this.el.style, this._optimisation, this._to);
                _context.next = 13;
                return this._delay();
...
var peek = {
  from: {
    filter: 'blur(2px)',
    webkitTransform: 'translate3d(50%, 50%, 0) scale(.5)',
...
var slideBottom = {
  from: {
    webkitTransform: 'translate3d(50%, -30%, 0)',
...
var slideRight = {
  from: {
    webkitTransform: 'translate3d(130%, 50%, 0)',
...
var slideUp = {
  from: {
    webkitTransform: 'translate3d(50%, 130%, 0)',
...
var ApocModal = function () {
  function ApocModal() {
    ...
    var type = this.opts.type.replace(/-[a-z]/g, function (m) {
    ...
    this.opened = false;
    // $FlowFixMe
    this.defaultStyle = _Object$assign({}, el.style);
  }

  _createClass(ApocModal, [{
    key: 'initEl',
    value: function initEl(el) {
      // $FlowFixMe
      _Object$assign(el.style, _extends$1({
        display: '',
        position: 'fixed',
    ...
    value: function createWall() {
      ...
      // $FlowFixMe
      _Object$assign(wall.style, _extends$1({
        position: 'fixed',
        top: '0',
        left: '0',
        width: '100%',
